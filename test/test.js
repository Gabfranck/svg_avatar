...
describe('#should fail', function() {
	...
	it('avatar to string fail avatar', function() {
		var test_avatar = {'form':0,'toto':0,'eye':0,'color1':0,'color2':0}
	...
	it('generate svg from object fail avatar', function() {
		var test_avatar = {'form':0,'mouth':0,'color1':0,'color2':0}
	...
	it('generate svg from string fail avatar', function() {
		var test_avatar = '{"form":0,"eye":0,"mouth":0,"color2":0}'
		svg_avatar.render_svg(test_avatar).should.deep.equal({'error': true, 'msg':'unvalid avatar'})
	})

	it('next part fail part', function() {
		var test_avatar = {'form':0,'mouth':0,'eye':0,'color1':0,'color2':0}
		svg_avatar.next_part_avatar(test_avatar, 'toto').should.deep.equal({'error': true, 'msg':'unvalid part'})
	})
	it('next part fail avatar', function() {
		var test_avatar = {'form':0,'mouth':0,'eye':0,'color1':0}
		svg_avatar.next_part_avatar(test_avatar, 'eyes').should.deep.equal({'error': true, 'msg':'unvalid avatar'})
	})

	it('next part svg fail part', function() {
		var test_avatar = {'form':0,'mouth':0,'eye':0,'color1':0,'color2':0}
		svg_avatar.next_part_svg(test_avatar, 'toto').should.deep.equal({'error': true, 'msg':'unvalid part'})	})

	it('next part svg fail avatar', function() {
		var test_avatar = {'form':0,'mouth':0,'tutu':0,'color1':0,'color2':0}
		svg_avatar.next_part_svg(test_avatar, 'eyes').should.deep.equal({'error': true, 'msg':'unvalid avatar'})
	})

	it('previous part fail part', function() {
		var test_avatar = {'form':0,'mouth':0,'eye':0,'color1':0,'color2':0}
		svg_avatar.previous_part_avatar(test_avatar, 'toto').should.deep.equal({'error': true, 'msg':'unvalid part'})
	})
	it('previous part fail avatar', function() {
		var test_avatar = {'form':0,'mouth':0,'eye':0,'color1':0}
		svg_avatar.previous_part_avatar(test_avatar, 'eyes').should.deep.equal({'error': true, 'msg':'unvalid avatar'})
	})

	it('previous part svg fail part', function() {
		var test_avatar = {'form':0,'mouth':0,'eye':0,'color1':0,'color2':0}
		svg_avatar.previous_part_svg(test_avatar, 'toto').should.deep.equal({'error': true, 'msg':'unvalid part'})	})

	it('previous part svg fail avatar', function() {
		var test_avatar = {'form':0,'mouth':0,'tutu':0,'color1':0,'color2':0}
		svg_avatar.previous_part_svg(test_avatar, 'eyes').should.deep.equal({'error': true, 'msg':'unvalid avatar'})
	})
})